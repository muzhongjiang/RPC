...
//
//	@Override
//	public void asyncSend(String address, RpcRequest xxlRpcRequest) throws Exception {
//		// do invoke
...
//     * @throws Exception
//     */
//    private void postRequestAsync(String address, RpcRequest xxlRpcRequest) throws Exception {
//
//		// reqURL
...
//                    RpcResponse xxlRpcResponse = (RpcResponse) xxlRpcReferenceBean.getSerializer().deserialize(responseBytes, RpcResponse.class);
//
//                    // notify response
...
//                            RpcRequest requestTmp = (RpcRequest) xxlRpcReferenceBean.getSerializer().deserialize(requestCp.iterator().next().array(), RpcRequest.class);
//
//							// error msg
...
//	public static HttpClient getJettyHttpClient(final RpcInvokerFactory xxlRpcInvokerFactory) throws Exception {
//
//		// get
...
//
//	/*@Override
//	public RpcResponse send(String address, RpcRequest xxlRpcRequest) throws Exception {
//
//		// reqURL
//		if (!address.toLowerCase().startsWith("http")) {
...
//
//		// deserialize response
//		return (RpcResponse) xxlRpcReferenceBean.getSerializer().deserialize(responseBytes, RpcResponse.class);
//
//	}*/
//
//	/**
...
//			throw new RuntimeException("rpc remoting request fail, http HttpStatus["+ response.getStatus() +"] invalid.");
//		}
//
//		// result
//		byte[] responseBytes = response.getContent();
//		if (responseBytes == null || responseBytes.length==0) {
//			throw new RuntimeException("rpc remoting request fail, response bytes is empty.");
//		}
//

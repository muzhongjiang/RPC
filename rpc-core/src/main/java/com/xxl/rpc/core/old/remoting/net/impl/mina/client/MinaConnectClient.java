...
//
//	@Override
//	public void init(String address, final Serializer serializer, final RpcInvokerFactory xxlRpcInvokerFactory) {
//
//		// host port
...
//				return Beat.BEAT_ID.equalsIgnoreCase(((RpcResponse) message).getRequestId());	// beat request
//			}
//			@Override
//			public boolean isResponse(IoSession ioSession, Object message) {
//				return Beat.BEAT_ID.equalsIgnoreCase(((RpcRequest) message).getRequestId());		// beat response
//			}
//			@Override
...
//		}
//
//		logger.debug(">>>>>>>>>>> rpc mina client proxy, connect to server success at host:{}, port:{}", host, port);
//	}
//
//
//	@Override
...
//		}
//		logger.debug(">>>>>>>>>>> rpc mina client close.");
//	}
//
//	@Override
//	public void send(RpcRequest xxlRpcRequest) {
